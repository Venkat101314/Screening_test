...
const PartnerPanel = () => {
  ...
  const [confirm, setConfirm] = React.useState(false); //Confirmation Dialog Box
  ...
  const updatePartner = (e) => {
    ...
    userData.append("is_active", formik.values.is_active);
  ...
  const handlePartner = (e) => {
    ...
    formik.setFieldValue('is_active',(e.row.is_active==='Active'? true: false) )
  };
        ...
        <Items>
          ...
          >
            <DialogTitle className={classes.dialogBoxTitle}>
              <Typography>
                {status  ? "Partner Creation" : "Update Partner"}
              </Typography>
                ...
                <Grid item xs={6}>
                  ...
                  <div className="d-flex">
                        ...
                        selectedImage && (
                          ...
                          >
                            ...
                            <img
                              ...
                              style={{width:'100%', maxHeight: "100px", height: 100 }}
                            />
                          </Box>
                        )
                      ) : (
                    ...
                    <Grid item xs={6}>
                      ...
                      {/* {status?(selectedImage && <p>{selectedImage.name}</p>):(<p>File must be *jpeg, *jpg, *png</p>)} */}
